...
function nuovaCollezioneClicked() {
    const categoria = "men's clothing"; // Imposta la categoria desiderata
//chiamata all api con il fetch  per recuperare tutti i prodotti
    fetch("https://fakestoreapi.com/products")
        ...
        .then(data => { // mi scorro tutti i dati 
            ...
            //  (in questo caso "men's clothing").simulo che la categoria restituita dall api abbia lo stesso tipo di carattere della categoria che ho settato inizialmente in modo da risultare che il confronto sia uguale.
...
function toggleDescription(productId) { ////accetta l ingresso id del prodot
